		...
		<div className="flex flex-col min-h-screen bg-white pt-24">
			<section className="px-6 py-12 max-w-7xl mx-auto w-full">
				...
				<p className="text-lg text-zinc-600 max-w-3xl font-montserrat mb-12">
					Browse and manage all uploaded assets. You can search for
					specific files, preview images, and copy direct URLs for use
					in your projects.
				</p>
					...
					{filteredFiles.map((file) => (
						<div key={file} className="flex flex-col">
							...
							<div className="flex-grow">
								<p
									className="text-xs font-medium text-zinc-500 font-montserrat truncate mb-1"
									title={file}
								>
								...
								<h3
									className="text-lg font-bold text-zinc-900 font-montserrat truncate mb-4"
